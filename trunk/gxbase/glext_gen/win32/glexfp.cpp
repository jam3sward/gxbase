...
extern HGLRC WINAPI stub_wglCreateContextAttribsARB (HDC, HGLRC, const int *) {
	return (HGLRC)0;
}
...
extern BOOL WINAPI stub_wglSetStereoEmitterState3DL (HDC, UINT) {
	return (BOOL)0;
}
extern int WINAPI stub_wglEnumerateVideoDevicesNV (HDC, HVIDEOOUTPUTDEVICENV *) {
	return (int)0;
}
extern BOOL WINAPI stub_wglBindVideoDeviceNV (HDC, unsigned int, HVIDEOOUTPUTDEVICENV, const int *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryCurrentContextNV (int, int *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetVideoDeviceNV (HDC, int, HPVIDEODEV *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglReleaseVideoDeviceNV (HPVIDEODEV) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglBindVideoImageNV (HPVIDEODEV, HPBUFFERARB, int) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglReleaseVideoImageNV (HPBUFFERARB, int) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSendPbufferToVideoNV (HPBUFFERARB, int, unsigned long *, BOOL) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetVideoInfoNV (HPVIDEODEV, unsigned long *, unsigned long *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglJoinSwapGroupNV (HDC, GLuint) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglBindSwapBarrierNV (GLuint, GLuint) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQuerySwapGroupNV (HDC, GLuint *, GLuint *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryMaxSwapGroupsNV (HDC, GLuint *, GLuint *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryFrameCountNV (HDC, GLuint *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglResetFrameCountNV (HDC) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglEnumGpusNV (UINT, HGPUNV *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglEnumGpuDevicesNV (HGPUNV, UINT, PGPU_DEVICE) {
	return (BOOL)0;
}
extern HDC WINAPI stub_wglCreateAffinityDCNV (const HGPUNV *) {
	return (HDC)0;
}
extern BOOL WINAPI stub_wglEnumGpusFromAffinityDCNV (HDC, UINT, HGPUNV *) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglDeleteDCNV (HDC) {
	return (BOOL)0;
}
extern UINT WINAPI stub_wglGetGPUIDsAMD (UINT, UINT *) {
	return (UINT)0;
}
extern INT WINAPI stub_wglGetGPUInfoAMD (UINT, int, GLenum, UINT, void *) {
	return (INT)0;
}
extern UINT WINAPI stub_wglGetContextGPUIDAMD (HGLRC) {
	return (UINT)0;
}
extern HGLRC WINAPI stub_wglCreateAssociatedContextAMD (UINT) {
	return (HGLRC)0;
}
extern HGLRC WINAPI stub_wglCreateAssociatedContextAttribsAMD (UINT, HGLRC, const int *) {
	return (HGLRC)0;
}
extern BOOL WINAPI stub_wglDeleteAssociatedContextAMD (HGLRC) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglMakeAssociatedContextCurrentAMD (HGLRC) {
	return (BOOL)0;
}
extern HGLRC WINAPI stub_wglGetCurrentAssociatedContextAMD (void) {
	return (HGLRC)0;
}
extern VOID WINAPI stub_wglBlitContextFramebufferAMD (HGLRC, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum) {
}
...
bool glexfp::Load() {
	...
	p = wglGetProcAddress("glFramebufferTextureFace");
	if (p) {
