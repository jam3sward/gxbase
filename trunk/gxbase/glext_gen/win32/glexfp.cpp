 ...
 * Generated on Wed Nov 14 21:38:27 2012
...
extern HANDLE WINAPI stub_wglCreateBufferRegionARB (HDC hDC, int iLayerPlane, UINT uType) {
	return (HANDLE)0;
}
extern VOID WINAPI stub_wglDeleteBufferRegionARB (HANDLE hRegion) {
}
extern BOOL WINAPI stub_wglSaveBufferRegionARB (HANDLE hRegion, int x, int y, int width, int height) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglRestoreBufferRegionARB (HANDLE hRegion, int x, int y, int width, int height, int xSrc, int ySrc) {
	return (BOOL)0;
}
extern const char * WINAPI stub_wglGetExtensionsStringARB (HDC hdc) {
	return (const char *)0;
}
extern BOOL WINAPI stub_wglGetPixelFormatAttribivARB (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int *piAttributes, int *piValues) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetPixelFormatAttribfvARB (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int *piAttributes, FLOAT *pfValues) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglChoosePixelFormatARB (HDC hdc, const int *piAttribIList, const FLOAT *pfAttribFList, UINT nMaxFormats, int *piFormats, UINT *nNumFormats) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglMakeContextCurrentARB (HDC hDrawDC, HDC hReadDC, HGLRC hglrc) {
	return (BOOL)0;
}
extern HDC WINAPI stub_wglGetCurrentReadDCARB (void) {
	return (HDC)0;
}
extern HPBUFFERARB WINAPI stub_wglCreatePbufferARB (HDC hDC, int iPixelFormat, int iWidth, int iHeight, const int *piAttribList) {
	return (HPBUFFERARB)0;
}
extern HDC WINAPI stub_wglGetPbufferDCARB (HPBUFFERARB hPbuffer) {
	return (HDC)0;
}
extern int WINAPI stub_wglReleasePbufferDCARB (HPBUFFERARB hPbuffer, HDC hDC) {
	return (int)0;
}
extern BOOL WINAPI stub_wglDestroyPbufferARB (HPBUFFERARB hPbuffer) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryPbufferARB (HPBUFFERARB hPbuffer, int iAttribute, int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglBindTexImageARB (HPBUFFERARB hPbuffer, int iBuffer) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglReleaseTexImageARB (HPBUFFERARB hPbuffer, int iBuffer) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSetPbufferAttribARB (HPBUFFERARB hPbuffer, const int *piAttribList) {
	return (BOOL)0;
}
extern HGLRC WINAPI stub_wglCreateContextAttribsARB (HDC hDC, HGLRC hShareContext, const int *attribList) {
	return (HGLRC)0;
}
extern GLboolean WINAPI stub_wglCreateDisplayColorTableEXT (GLushort id) {
	return (GLboolean)0;
}
extern GLboolean WINAPI stub_wglLoadDisplayColorTableEXT (const GLushort *table, GLuint length) {
	return (GLboolean)0;
}
extern GLboolean WINAPI stub_wglBindDisplayColorTableEXT (GLushort id) {
	return (GLboolean)0;
}
extern VOID WINAPI stub_wglDestroyDisplayColorTableEXT (GLushort id) {
}
extern const char * WINAPI stub_wglGetExtensionsStringEXT (void) {
	return (const char *)0;
}
extern BOOL WINAPI stub_wglMakeContextCurrentEXT (HDC hDrawDC, HDC hReadDC, HGLRC hglrc) {
	return (BOOL)0;
}
extern HDC WINAPI stub_wglGetCurrentReadDCEXT (void) {
	return (HDC)0;
}
extern HPBUFFEREXT WINAPI stub_wglCreatePbufferEXT (HDC hDC, int iPixelFormat, int iWidth, int iHeight, const int *piAttribList) {
	return (HPBUFFEREXT)0;
}
extern HDC WINAPI stub_wglGetPbufferDCEXT (HPBUFFEREXT hPbuffer) {
	return (HDC)0;
}
extern int WINAPI stub_wglReleasePbufferDCEXT (HPBUFFEREXT hPbuffer, HDC hDC) {
	return (int)0;
}
extern BOOL WINAPI stub_wglDestroyPbufferEXT (HPBUFFEREXT hPbuffer) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryPbufferEXT (HPBUFFEREXT hPbuffer, int iAttribute, int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetPixelFormatAttribivEXT (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, int *piAttributes, int *piValues) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetPixelFormatAttribfvEXT (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, int *piAttributes, FLOAT *pfValues) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglChoosePixelFormatEXT (HDC hdc, const int *piAttribIList, const FLOAT *pfAttribFList, UINT nMaxFormats, int *piFormats, UINT *nNumFormats) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSwapIntervalEXT (int interval) {
	return (BOOL)0;
}
extern int WINAPI stub_wglGetSwapIntervalEXT (void) {
	return (int)0;
}
extern void* WINAPI stub_wglAllocateMemoryNV (GLsizei size, GLfloat readfreq, GLfloat writefreq, GLfloat priority) {
	return (void*)0;
}
extern void WINAPI stub_wglFreeMemoryNV (void *pointer) {
}
extern BOOL WINAPI stub_wglGetSyncValuesOML (HDC hdc, INT64 *ust, INT64 *msc, INT64 *sbc) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetMscRateOML (HDC hdc, INT32 *numerator, INT32 *denominator) {
	return (BOOL)0;
}
extern INT64 WINAPI stub_wglSwapBuffersMscOML (HDC hdc, INT64 target_msc, INT64 divisor, INT64 remainder) {
	return (INT64)0;
}
extern INT64 WINAPI stub_wglSwapLayerBuffersMscOML (HDC hdc, int fuPlanes, INT64 target_msc, INT64 divisor, INT64 remainder) {
	return (INT64)0;
}
extern BOOL WINAPI stub_wglWaitForMscOML (HDC hdc, INT64 target_msc, INT64 divisor, INT64 remainder, INT64 *ust, INT64 *msc, INT64 *sbc) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglWaitForSbcOML (HDC hdc, INT64 target_sbc, INT64 *ust, INT64 *msc, INT64 *sbc) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetDigitalVideoParametersI3D (HDC hDC, int iAttribute, int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSetDigitalVideoParametersI3D (HDC hDC, int iAttribute, const int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetGammaTableParametersI3D (HDC hDC, int iAttribute, int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSetGammaTableParametersI3D (HDC hDC, int iAttribute, const int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetGammaTableI3D (HDC hDC, int iEntries, USHORT *puRed, USHORT *puGreen, USHORT *puBlue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSetGammaTableI3D (HDC hDC, int iEntries, const USHORT *puRed, const USHORT *puGreen, const USHORT *puBlue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglEnableGenlockI3D (HDC hDC) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglDisableGenlockI3D (HDC hDC) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglIsEnabledGenlockI3D (HDC hDC, BOOL *pFlag) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGenlockSourceI3D (HDC hDC, UINT uSource) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetGenlockSourceI3D (HDC hDC, UINT *uSource) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGenlockSourceEdgeI3D (HDC hDC, UINT uEdge) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetGenlockSourceEdgeI3D (HDC hDC, UINT *uEdge) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGenlockSampleRateI3D (HDC hDC, UINT uRate) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetGenlockSampleRateI3D (HDC hDC, UINT *uRate) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGenlockSourceDelayI3D (HDC hDC, UINT uDelay) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetGenlockSourceDelayI3D (HDC hDC, UINT *uDelay) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryGenlockMaxSourceDelayI3D (HDC hDC, UINT *uMaxLineDelay, UINT *uMaxPixelDelay) {
	return (BOOL)0;
}
extern LPVOID WINAPI stub_wglCreateImageBufferI3D (HDC hDC, DWORD dwSize, UINT uFlags) {
	return (LPVOID)0;
}
extern BOOL WINAPI stub_wglDestroyImageBufferI3D (HDC hDC, LPVOID pAddress) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglAssociateImageBufferEventsI3D (HDC hDC, const HANDLE *pEvent, const LPVOID *pAddress, const DWORD *pSize, UINT count) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglReleaseImageBufferEventsI3D (HDC hDC, const LPVOID *pAddress, UINT count) {
	return (BOOL)0;
}
...
extern BOOL WINAPI stub_wglIsEnabledFrameLockI3D (BOOL *pFlag) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryFrameLockMasterI3D (BOOL *pFlag) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetFrameUsageI3D (float *pUsage) {
	return (BOOL)0;
}
...
extern BOOL WINAPI stub_wglQueryFrameTrackingI3D (DWORD *pFrameCount, DWORD *pMissedFrames, float *pLastMissedUsage) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSetStereoEmitterState3DL (HDC hDC, UINT uState) {
	return (BOOL)0;
}
extern int WINAPI stub_wglEnumerateVideoDevicesNV (HDC hDC, HVIDEOOUTPUTDEVICENV *phDeviceList) {
	return (int)0;
}
extern BOOL WINAPI stub_wglBindVideoDeviceNV (HDC hDC, unsigned int uVideoSlot, HVIDEOOUTPUTDEVICENV hVideoDevice, const int *piAttribList) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryCurrentContextNV (int iAttribute, int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetVideoDeviceNV (HDC hDC, int numDevices, HPVIDEODEV *hVideoDevice) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglReleaseVideoDeviceNV (HPVIDEODEV hVideoDevice) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglBindVideoImageNV (HPVIDEODEV hVideoDevice, HPBUFFERARB hPbuffer, int iVideoBuffer) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglReleaseVideoImageNV (HPBUFFERARB hPbuffer, int iVideoBuffer) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglSendPbufferToVideoNV (HPBUFFERARB hPbuffer, int iBufferType, unsigned long *pulCounterPbuffer, BOOL bBlock) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglGetVideoInfoNV (HPVIDEODEV hpVideoDevice, unsigned long *pulCounterOutputPbuffer, unsigned long *pulCounterOutputVideo) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglJoinSwapGroupNV (HDC hDC, GLuint group) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglBindSwapBarrierNV (GLuint group, GLuint barrier) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQuerySwapGroupNV (HDC hDC, GLuint *group, GLuint *barrier) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryMaxSwapGroupsNV (HDC hDC, GLuint *maxGroups, GLuint *maxBarriers) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryFrameCountNV (HDC hDC, GLuint *count) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglResetFrameCountNV (HDC hDC) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglEnumGpusNV (UINT iGpuIndex, HGPUNV *phGpu) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglEnumGpuDevicesNV (HGPUNV hGpu, UINT iDeviceIndex, PGPU_DEVICE lpGpuDevice) {
	return (BOOL)0;
}
extern HDC WINAPI stub_wglCreateAffinityDCNV (const HGPUNV *phGpuList) {
	return (HDC)0;
}
extern BOOL WINAPI stub_wglEnumGpusFromAffinityDCNV (HDC hAffinityDC, UINT iGpuIndex, HGPUNV *hGpu) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglDeleteDCNV (HDC hdc) {
	return (BOOL)0;
}
extern UINT WINAPI stub_wglGetGPUIDsAMD (UINT maxCount, UINT *ids) {
	return (UINT)0;
}
extern INT WINAPI stub_wglGetGPUInfoAMD (UINT id, int property, GLenum dataType, UINT size, void *data) {
	return (INT)0;
}
extern UINT WINAPI stub_wglGetContextGPUIDAMD (HGLRC hglrc) {
	return (UINT)0;
}
extern HGLRC WINAPI stub_wglCreateAssociatedContextAMD (UINT id) {
	return (HGLRC)0;
}
extern HGLRC WINAPI stub_wglCreateAssociatedContextAttribsAMD (UINT id, HGLRC hShareContext, const int *attribList) {
	return (HGLRC)0;
}
extern BOOL WINAPI stub_wglDeleteAssociatedContextAMD (HGLRC hglrc) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglMakeAssociatedContextCurrentAMD (HGLRC hglrc) {
	return (BOOL)0;
}
extern HGLRC WINAPI stub_wglGetCurrentAssociatedContextAMD (void) {
	return (HGLRC)0;
}
extern VOID WINAPI stub_wglBlitContextFramebufferAMD (HGLRC dstCtx, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter) {
}
extern BOOL WINAPI stub_wglBindVideoCaptureDeviceNV (UINT uVideoSlot, HVIDEOINPUTDEVICENV hDevice) {
	return (BOOL)0;
}
extern UINT WINAPI stub_wglEnumerateVideoCaptureDevicesNV (HDC hDc, HVIDEOINPUTDEVICENV *phDeviceList) {
	return (UINT)0;
}
extern BOOL WINAPI stub_wglLockVideoCaptureDeviceNV (HDC hDc, HVIDEOINPUTDEVICENV hDevice) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglQueryVideoCaptureDeviceNV (HDC hDc, HVIDEOINPUTDEVICENV hDevice, int iAttribute, int *piValue) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglReleaseVideoCaptureDeviceNV (HDC hDc, HVIDEOINPUTDEVICENV hDevice) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglCopyImageSubDataNV (HGLRC hSrcRC, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, HGLRC hDstRC, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglDXSetResourceShareHandleNV (void *dxObject, HANDLE shareHandle) {
	return (BOOL)0;
}
extern HANDLE WINAPI stub_wglDXOpenDeviceNV (void *dxDevice) {
	return (HANDLE)0;
}
extern BOOL WINAPI stub_wglDXCloseDeviceNV (HANDLE hDevice) {
	return (BOOL)0;
}
extern HANDLE WINAPI stub_wglDXRegisterObjectNV (HANDLE hDevice, void *dxObject, GLuint name, GLenum type, GLenum access) {
	return (HANDLE)0;
}
extern BOOL WINAPI stub_wglDXUnregisterObjectNV (HANDLE hDevice, HANDLE hObject) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglDXObjectAccessNV (HANDLE hObject, GLenum access) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglDXLockObjectsNV (HANDLE hDevice, GLint count, HANDLE *hObjects) {
	return (BOOL)0;
}
extern BOOL WINAPI stub_wglDXUnlockObjectsNV (HANDLE hDevice, GLint count, HANDLE *hObjects) {
	return (BOOL)0;
}
