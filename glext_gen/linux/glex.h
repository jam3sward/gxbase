...
inline void glex::glSampleCoverage(GLfloat  a, GLboolean  b) {
...
inline void glex::glDepthRangef(GLfloat  a, GLfloat  b) {
	m_pglex->glDepthRangef(a,b);
}

inline void glex::glClearDepthf(GLfloat  a) {
...
inline void glex::glDepthRangeArrayv(GLuint  a, GLsizei  b, const GLdouble *c) {
	m_pglex->glDepthRangeArrayv(a,b,c);
}

inline void glex::glDepthRangeIndexed(GLuint  a, GLdouble  b, GLdouble  c) {
...
inline void glex::glClearBufferData(GLenum  a, GLenum  b, GLenum  c, GLenum  d, const void *e) {
	m_pglex->glClearBufferData(a,b,c,d,e);
}
...
inline void glex::glDispatchCompute(GLuint  a, GLuint  b, GLuint  c) {
	m_pglex->glDispatchCompute(a,b,c);
}

inline void glex::glDispatchComputeIndirect(GLintptr  a) {
	m_pglex->glDispatchComputeIndirect(a);
}

inline void glex::glCopyImageSubData(GLuint  a, GLenum  b, GLint  c, GLint  d, GLint  e, GLint  f, GLuint  g, GLenum  h, GLint  i, GLint  j, GLint  k, GLint  l, GLsizei  m, GLsizei  n, GLsizei  o) {
...
inline void glex::glGetInternalformati64v(GLenum  a, GLenum  b, GLenum  c, GLsizei  d, GLint64 *e) {
	m_pglex->glGetInternalformati64v(a,b,c,d,e);
}

inline void glex::glInvalidateTexSubImage(GLuint  a, GLint  b, GLint  c, GLint  d, GLint  e, GLsizei  f, GLsizei  g, GLsizei  h) {
	m_pglex->glInvalidateTexSubImage(a,b,c,d,e,f,g,h);
}

inline void glex::glInvalidateTexImage(GLuint  a, GLint  b) {
	m_pglex->glInvalidateTexImage(a,b);
}

inline void glex::glInvalidateBufferSubData(GLuint  a, GLintptr  b, GLsizeiptr  c) {
	m_pglex->glInvalidateBufferSubData(a,b,c);
}

inline void glex::glInvalidateBufferData(GLuint  a) {
	m_pglex->glInvalidateBufferData(a);
}

inline void glex::glInvalidateFramebuffer(GLenum  a, GLsizei  b, const GLenum *c) {
	m_pglex->glInvalidateFramebuffer(a,b,c);
}

inline void glex::glInvalidateSubFramebuffer(GLenum  a, GLsizei  b, const GLenum *c, GLint  d, GLint  e, GLsizei  f, GLsizei  g) {
	m_pglex->glInvalidateSubFramebuffer(a,b,c,d,e,f,g);
}

inline void glex::glMultiDrawArraysIndirect(GLenum  a, const void *b, GLsizei  c, GLsizei  d) {
	m_pglex->glMultiDrawArraysIndirect(a,b,c,d);
}

inline void glex::glMultiDrawElementsIndirect(GLenum  a, GLenum  b, const void *c, GLsizei  d, GLsizei  e) {
	m_pglex->glMultiDrawElementsIndirect(a,b,c,d,e);
}

inline void glex::glGetProgramInterfaceiv(GLuint  a, GLenum  b, GLenum  c, GLint *d) {
	m_pglex->glGetProgramInterfaceiv(a,b,c,d);
}

inline GLuint glex::glGetProgramResourceIndex(GLuint  a, GLenum  b, const GLchar *c) {
	return m_pglex->glGetProgramResourceIndex(a,b,c);
}

inline void glex::glGetProgramResourceName(GLuint  a, GLenum  b, GLuint  c, GLsizei  d, GLsizei *e, GLchar *f) {
	m_pglex->glGetProgramResourceName(a,b,c,d,e,f);
}

inline void glex::glGetProgramResourceiv(GLuint  a, GLenum  b, GLuint  c, GLsizei  d, const GLenum *e, GLsizei  f, GLsizei *g, GLint *h) {
	m_pglex->glGetProgramResourceiv(a,b,c,d,e,f,g,h);
}

inline GLint glex::glGetProgramResourceLocation(GLuint  a, GLenum  b, const GLchar *c) {
	return m_pglex->glGetProgramResourceLocation(a,b,c);
}

inline GLint glex::glGetProgramResourceLocationIndex(GLuint  a, GLenum  b, const GLchar *c) {
	return m_pglex->glGetProgramResourceLocationIndex(a,b,c);
}

inline void glex::glShaderStorageBlockBinding(GLuint  a, GLuint  b, GLuint  c) {
	m_pglex->glShaderStorageBlockBinding(a,b,c);
}

inline void glex::glTexBufferRange(GLenum  a, GLenum  b, GLuint  c, GLintptr  d, GLsizeiptr  e) {
...
inline void glex::glTexStorage3DMultisample(GLenum  a, GLsizei  b, GLenum  c, GLsizei  d, GLsizei  e, GLsizei  f, GLboolean  g) {
